...
export default function ContactFormWithSocialButtons() {
  ...
  function handleSubmit(e) {
    ...
    if (isValidated) {
      axios
        .post("https://travelopiaserver.onrender.com/booking/", {
          ...formDetail,
        })
        .then((res) => {
          console.log(res)
              ...
              >
                <VStack spacing={10}>
                  <form onSubmit={handleSubmit}>
                    ...
                    <FormControl isRequired>
                      <FormLabel m={2}>Where Do you want to go?</FormLabel>

                      <Select
                        value={formDetail.destination}
                        onChange={handleChange}
                        name="destination"
...
function detailsValidator(formDetail) {
  // this function is
  if (
    formDetail.budget >= 10 &&
    formDetail.budget <= 1000000 &&
    formDetail.travellers >= 1 &&
    formDetail.travellers <= 100
  ) {
    // if yes send data to the backend
    return true;
  } else {
    return false;
    //show modal box here
...
//                         <Input onChange = {handleChange} minLength ={"0"} type="text" name="name" value={formDetail.name} placeholder="Your Name" />
//                       </InputGroup>
//                     </FormControl>
...
//                     <Select value = {formDetail.destination} onChange = {handleChange} name="destination"   placeholder="where do you want to go?"
//                     rows={6}
//                     resize="none">
//                     <option value="India">India</option>
//                     <option value="Africa">Africa</option>
...
//                 <InputGroup>
//                 <InputLeftElement children={<AiOutlineDollarCircle/>} />
//                 <Input
//                 onChange = {handleChange}
//                 value = {formDetail.budget}
//                   type="number"
